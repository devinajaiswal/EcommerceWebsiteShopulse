...
import in.co.ecommerce.dao.ProductDAOInt;
...
public class ProductServiceImpl implements ProductServiceInt {
	...
	public ProductEntity findByCode(String code) {
		log.info("ProductServiceImpl  findByCode method start");
		ProductEntity bean = dao.findByCode(code);
		log.info("ProductServiceImpl findByCode method end");
		return bean;
	}
